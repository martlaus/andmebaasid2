...
INSERT INTO garaazh.organisatsioon(aadress, e_mail, nimi, registri_kood, tarneaeg, hinne, riik) VALUES ('Akadeemia tee 5, Tallinn 93811, Eesti', 'info@samsung.com', 'Samsung','110A2746B2C', 5.0, 5.0, 'EE');

INSERT INTO garaazh.organisatsioon(aadress, e_mail, nimi, registri_kood, tarneaeg, hinne, riik) VALUES ('Hobujaama 3, Tallinn 15334, Eesti', 'info@nokia.com', 'Nokia','210A2746B3D', 5.0, 5.0, 'EE');

INSERT INTO garaazh.organisatsioon(aadress, e_mail, nimi, registri_kood, tarneaeg, hinne, riik) VALUES ('Vilde tee 18, Tallinn 13545, Eesti', 'info@dell.com', 'Dell','310A2746B4E', 5.0, 5.0, 'EE');

INSERT INTO garaazh.organisatsioon(aadress, e_mail, nimi, registri_kood, tarneaeg, hinne, riik) VALUES ('Müürivahe 33, Tallinn 85773, Eesti', 'info@asus.com', 'Asus','410A2746B5F', 5.0, 5.0, 'EE');

INSERT INTO garaazh.organisatsioon(aadress, e_mail, nimi, registri_kood, tarneaeg, hinne, riik) VALUES ('Viru tn 9, Tallinn 34283, Eesti', 'info@intel.com', 'Intel','510A2746B6G', 5.0, 5.0, 'EE');
