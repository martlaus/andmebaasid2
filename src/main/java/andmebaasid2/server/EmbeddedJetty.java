package andmebaasid2.server;

import com.google.inject.servlet.GuiceFilter;
import andmebaasid2.config.Andmebaasid2Application;
...
public class EmbeddedJetty {
    ...
    private void configureDynamicContentServlet(ServletContextHandler servletContextHandler) {
        ...
        servlet.setInitParameter("javax.ws.rs.Application", Andmebaasid2Application.class.getCanonicalName());
